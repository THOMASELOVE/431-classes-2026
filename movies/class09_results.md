...
- Warning: MPA ratings (`mpa`) include multiple categories (really everything other than PG, PG-13 and R) with very few observations.
...
- Warning: Major problem with genres (`imdb_genres`) include that movies can have more than one genre (and as many as 8), and there are 20 different genres in our sample.
