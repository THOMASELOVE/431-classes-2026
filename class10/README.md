...
I'll be looking at your [Project A check-in](https://thomaselove.github.io/431-projectA-2026/#the-check-in) Quarto files personally, and in particular, at the packages you're loading and how you're loading them. Load all of the R packages you use or plan to use in your analyses, and not ones that you don't.
