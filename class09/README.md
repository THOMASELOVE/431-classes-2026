...
2. In Class 10, I'll be using [the `ggExtra` package](https://github.com/daattali/ggExtra), so I've added it to our [list of R packages to install](https://github.com/THOMASELOVE/431-packages). Please do.
